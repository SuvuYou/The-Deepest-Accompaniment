...
chords_data_loader = torch.utils.data.DataLoader(chords_dataset, batch_size=8, shuffle=True) 
# melody_data_loader = torch.utils.data.DataLoader(melody_dataset, batch_size=2, shuffle=True)   
