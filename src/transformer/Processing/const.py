...
MELODY_PITCH_MAPPINGS_PATH = f"{MAPPINGS_PATH}/melody_pitch_mappings.json"
MELODY_DURATION_MAPPINGS_PATH = f"{MAPPINGS_PATH}/melody_duration_mappings.json"
CHORDS_PITCH_MAPPINGS_PATH = f"{MAPPINGS_PATH}/chords_pitch_mappings.json"
CHORDS_DURATION_MAPPINGS_PATH = f"{MAPPINGS_PATH}/chords_duration_mappings.json"
...
CONSTANTS = DotDict({
    ...
    "MELODY_PITCH_MAPPINGS_PATH": MELODY_PITCH_MAPPINGS_PATH,
    "MELODY_DURATION_MAPPINGS_PATH": MELODY_DURATION_MAPPINGS_PATH,
    "CHORDS_PITCH_MAPPINGS_PATH": CHORDS_PITCH_MAPPINGS_PATH,
    "CHORDS_DURATION_MAPPINGS_PATH": CHORDS_DURATION_MAPPINGS_PATH,
    "CHORDS_DATA_CHUNKS_SAVE_PATH": CHORDS_DATA_CHUNKS_SAVE_PATH,
    "MELODY_DATA_CHUNKS_SAVE_PATH": MELODY_DATA_CHUNKS_SAVE_PATH,
    "CHORDS_VIDEO_CHUNKS_SAVE_PATH": CHORDS_VIDEO_CHUNKS_SAVE_PATH,
    "MELODY_VIDEO_CHUNKS_SAVE_PATH": MELODY_VIDEO_CHUNKS_SAVE_PATH,
